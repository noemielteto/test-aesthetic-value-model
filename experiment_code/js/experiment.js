...
var instructions = {
    ...
    overview: `
        ...
        This study consists of three main parts.</p>

        <p>In the first part, we will show you a series of images. You will be free
        to view each image for as long as you want before moving on to the next. 
        This part will take about 15 minutes.</p>
        
        <p>In the second part, you will see each image from the first part again. 
        We will then ask you to tell us your opinion on each of them.<br>
        This part should take about 10 - 15 minutes.</p>
        
        <p>At the end of the study, we will also ask you some questions about
        yourself.</p>

        <p>The study will take about 40 minutes in total to complete.</p>
    ...
    viewingMainTask: `
        ...
        <p>You will view several different pictures in the first part of our study. You 
        can think of this part of the study as if you were browsing through an 
    ...
    viewingSummary: `
        ...
        <p>Remember: You will now view a series of images for 15 minutes. Look at 
    ...
    rating: `
        ...
        <p>Thank you for completing the first part of our study.</p>

        <p>In the second part, you will rate each of the images you just saw 
        according to how much you like them. You will use a slider ranging from 'not at all' to 
        'very much' to indicate how much you like each image. Please try to use 
        the full range of the slider. That is, rate the image you like the least 
        'not at all' and the image you liked the most 'very much'.</p>
...
// CREATE RATING STIMULUS ARRAY (110 IMAGES)
...
// checks whether the last element of temp1 & first element of temp2 are the same
if(temp1[temp1.length - 1] == temp2[0]) {
    temp2.push(temp2[0]); // move first element to the end
    temp2.shift(); // remove first element
}
...
console.log("ratingStimuli: ", ratingStimuli);
...
var introRatingPart = {
    type: "html-button-response",
    stimulus: instructions.rating,
    choices: ["Continue"]
}
timeline.push(introRatingPart);
...
var otherQuestions = {
    ...
    questions: [
        {prompt: "<b>How much do you enjoy browsing images on apps like Instagram or the internet?</b>", name: "imageBrowsingLiking", options:questionOptions1, required: true, horizontal: true},
...
var strategyQuestions = {
    ...
    button_label: "Continue",
    html: `
        <p class="spaceUnderneath"><b>While clicking through our images, did you follow any specific strategies?</b> (optional)<br>
...
const timestamp  = year + twoDigit(month + 1) + twoDigit(day) + "_" + twoDigit(hour) + twoDigit(minute);
